...
box-shadow: 3px 3px 13px -1px rgba(54,51,54,1);">
                      ...
                      <div class="col-md-9" style="height: 100vh;">
                        ...
                        <div class="row">
                          <form method="post" action="../Controller/AddNewStaff.php">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
